...
public class Main {
    public static void main(String[] args) throws Exception {
        ArrayList<Integer> answers = new ArrayList<>(); // аррэйлист с ответами
        ...
        System.out.println("Do you want to read from file? y/n"); // вы что хотите тотальной войны????
        answer = in.nextLine();
        if (answer.toLowerCase().equals("y")) { // какой-то у вас странный инпут
        ...
        if (calculator instanceof Advanced_Calculator) {
            ...
            while (true) {
                ...
                if (answer.equals("restoreOp")) {
                    ...
                    switch (array.length) {
                    case 1: {
                        System.out.println(((Advanced_Calculator) calculator).calculate(0, Integer.parseInt(array[0]),
                                0, true, true));
                        answers.add(((Advanced_Calculator) calculator).calculate(0, Integer.parseInt(array[0]), 0, true,
                                true));
                        break;
                    }
                    case 2: {
                        ...
                        System.out.println(((Advanced_Calculator) calculator).calculate(0, Integer.parseInt(array[1]),
                                operation, true, false));
                        answers.add(((Advanced_Calculator) calculator).calculate(0, Integer.parseInt(array[1]),
                                operation, true, false));
                        break;
                    }
                    case 3: {
                        ...
                        int operation = options.getOperation();
                        System.out.println(((Advanced_Calculator) calculator).calculate(Integer.parseInt(array[0]),
                                Integer.parseInt(array[2]), operation, false, false));
                        answers.add(((Advanced_Calculator) calculator).calculate(Integer.parseInt(array[0]),
                                Integer.parseInt(array[2]), operation, false, false));
                        break;
                    }
                    }
            ...
            while (true) {
                ...
                if (answer.equals("break")) {
                    ...
                    int operation = options.getOperation();
                    System.out.println(
                            calculator.calculate(Integer.parseInt(array[0]), Integer.parseInt(array[2]), operation));
                    answers.add(
                            calculator.calculate(Integer.parseInt(array[0]), Integer.parseInt(array[2]), operation));
                }
        ...
        System.out.println("Do you want to write results in file?y/n"); // ЙЕС
        answer = in.nextLine();
        if (answer.toLowerCase().equals("y")) {
